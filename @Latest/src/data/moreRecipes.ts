...
export const moreRecipes: RecipeDetails[] = [
  {
  ...
  },
  {
    ...
    extendedIngredients: [
      ...
      { name: "tahini", image: "tahini.jpg", amount: 1, unit: "tbsp" }, { name: "soy sauce", image: "soy-sauce.jpg", amount: 2, unit: "tbsp" },
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1593001874117-c99c800e3eb2?auto=format&fit=crop&w=1200&q=85",
    ...
    extendedIngredients: [
      ...
      { name: "tahini", image: "tahini.jpg", amount: 0.5, unit: "cup" }, { name: "tomatoes", image: "tomato.png", amount: 3, unit: "" },
    ], analyzedInstructions: [{ steps: [
