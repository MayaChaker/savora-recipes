...
import { worldRecipes } from "./worldRecipes";

const coreRecipes: RecipeDetails[] = [
  {
    id: 9001,
...
export const curatedRecipes: RecipeDetails[] = [...coreRecipes, ...moreRecipes, ...worldRecipes];

export function findCuratedRecipes(query: string) {
